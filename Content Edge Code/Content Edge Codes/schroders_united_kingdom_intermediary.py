...
async def SIMUKI(target_date):
    results = []
    try:
        url = "https://www.schroders.com/en-gb/uk/intermediary/insights/"
        scraper = SchrodersScraperUK(target_date)

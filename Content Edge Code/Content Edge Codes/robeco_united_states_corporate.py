...
async def RobecoUSC(target_date):
    url = "https://www.robeco.com/en-us/insights/latest-insights"
...
if __name__ == "__main__":
    ...
    asyncio.run(RobecoUSC(target_date=target_date))

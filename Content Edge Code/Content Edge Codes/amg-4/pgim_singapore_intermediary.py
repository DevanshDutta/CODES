...
async def PGIMSGI(target_date):
    url = ("https://www.pgim.com/sg/en/intermediary/insights/thought-leadership/latest-insights"
    )
...
if __name__ == "__main__":
    ...
    asyncio.run(PGIMSGI(target_date))
...
async def PGIMUKI(target_date):
    url = ("https://www.pgim.com/gb/en/intermediary/insights/thought-leadership/latest-insights"
    )
...
if __name__ == "__main__":
    ...
    asyncio.run(PGIMUKI(target_date))

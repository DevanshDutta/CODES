...
async def RobecoSGC(target_date):
    url = "https://www.robeco.com/en-sg/insights/latest-insights"
...
if __name__ == "__main__":
    ...
    asyncio.run(RobecoSGC(target_date=target_date))

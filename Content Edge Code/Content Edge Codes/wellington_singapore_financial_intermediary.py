...
async def WMGSGFP(target_date):
    results = []
    try:
        url = "https://www.wellington.com/en-sg/intermediary/insights"
...
if __name__ == "__main__":
    ...
    asyncio.run(WMGSGFP(target_date=target_date))
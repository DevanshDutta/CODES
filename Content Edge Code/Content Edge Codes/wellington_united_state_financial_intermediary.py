...
async def WMGUSFP(target_date):
    results = []
    try:
        url = "https://www.wellington.com/en-us/intermediary/insights"
...
if __name__ == "__main__":
    ...
    asyncio.run(WMGUSFP(target_date=target_date))

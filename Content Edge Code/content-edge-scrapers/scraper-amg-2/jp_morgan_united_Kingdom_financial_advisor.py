...
async def JPMUKFA(target_date):
    results = []
    try:
        urls = [
            "https://am.jpmorgan.com/gb/en/asset-management/adv/insights/market-insights/",
            "https://am.jpmorgan.com/gb/en/asset-management/adv/insights/portfolio-insights/",
            "https://am.jpmorgan.com/gb/en/asset-management/adv/insights/etf-insights/",
            "https://am.jpmorgan.com/gb/en/asset-management/adv/investment-themes/sustainable-investing/sustainable-insights/",
        ]
...
if __name__ == "__main__":
    ...
    asyncio.run(JPMUKFA(target_date=target_date))

...
async def DFAUSFP(target_date):
    url = "https://www.dimensional.com/us-en/insights#t=catAll&sort=@publishdate%20descending"
...
if __name__ == "__main__":
    ...
    asyncio.run(DFAUSFP(target_date))

...
async def DFASGFP(target_date):
    url = "https://www.dimensional.com/hk-en/insights#t=catAll&sort=@publishdate%20descending"
...
if __name__ == "__main__":
    ...
    asyncio.run(DFASGFP(target_date))
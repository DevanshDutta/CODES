...
async def MANDGSGFP(target_date):
    url = "https://www.mandg.com/investments/professional-investor/en-sg/insights/mandg-insights/latest-insights"
...
if __name__ == "__main__":
    ...
    asyncio.run(MANDGSGFP(target_date))
